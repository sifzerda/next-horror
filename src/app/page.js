...
export default function Home() {
  return (
    <div className="flex">
      ...
      <div className="flex-1 min-h-screen bg-white dark:bg-black text-black dark:text-white">
        <Navigation /> {/* Top nav */}

        <main className="pt-24 pl-64 pr-6 pb-6 flex flex-col gap-8 items-center sm:items-start">
          {/* pt-24 ensures space for the fixed top nav */}
          <Image
